...
public class Indexer {
	...
	private Document getDocument(File file) throws IOException {
		...
		// index file name
		Field fileNameField = new Field(LuceneConstant.FILE_NAME, file.getName(), Field.Store.YES,
				Field.Index.NOT_ANALYZED);
		// index file path
		Field filePathField = new Field(LuceneConstant.FILE_PATH, file.getCanonicalPath(), Field.Store.YES,
				Field.Index.NOT_ANALYZED);
